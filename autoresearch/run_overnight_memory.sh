...
#
# Current baseline: val_sharpe=2.7790, val_return=+301.45%, OOS=2.98

set -e
cd "$(dirname "$0")/.."

echo "=== Memory Overnight Autoresearch ==="
echo "Baseline: sharpe=2.7790 | Run: poetry run python -m autoresearch.evaluate --params autoresearch.params_memory"
