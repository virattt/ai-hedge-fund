"""
autoresearch/params_power.py — Sector-specific params for power/infra (VST, CEG, NRG).

Universe: VST, CEG, NRG
Regime: Utility/clean-energy transition, rate-sensitive. Tech momentum params do NOT generalize.

Baseline (tech params): Sharpe -0.02, return +0.9%, max DD -21.5%
→ Needs full sector-specific tuning. Start with more mean-reversion bias.

Run: poetry run python -m autoresearch.evaluate --params autoresearch.params_power
"""

# Full copy from params.py with sector overrides (power = rate-sensitive, mean-reversion regime)
STRATEGY_WEIGHTS = {
    "trend": 0.25,
    "mean_reversion": 0.35,
    "momentum": 0.25,
