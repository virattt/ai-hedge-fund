"""
autoresearch/params_memory.py — Sector-specific params for memory/storage (MU, WDC, STX).

Universe: MU, WDC, STX
Regime: Highly cyclical, DRAM/NAND cycle, strong momentum when cycle turns.

Baseline (tech params): Sharpe 2.44, return +229.6%, max DD -18.7%
→ Already generalizes extremely well! Tune from tech baseline.

Run: poetry run python -m autoresearch.evaluate --params autoresearch.params_memory
"""
...
SIGNAL_BULLISH_THRESHOLD = 0.34
SIGNAL_BEARISH_THRESHOLD = -0.2

RISK_BASE_LIMIT = 0.34

RISK_VOL_BANDS = [(0.15, 1.25), (0.40, 1.00), (0.70, 1.00)]
RISK_EXTREME_VOL_MULT = 0.80
