"""
autoresearch/params_eda.py — Sector-specific params for EDA + design IP (SNPS, CDNS, ARM).

Universe: SNPS, CDNS, ARM (Synopsys, Cadence, ARM Holdings)
Regime: EDA duopoly + design IP. ARM expands from 2-ticker limit.
Ref: ikigaistudio "The Fund, Rebalanced" — EDA 17%, most durable category.

Run: poetry run python -m autoresearch.evaluate --params autoresearch.params_eda
"""
