...
def fetch_interest_rates(start_date: str, end_date: str) -> dict:
    """Fetch macro interest-rate data from Financial Datasets."""
    api_key = os.environ.get("FINANCIAL_DATASETS_API_KEY", "")
    headers = {"X-API-KEY": api_key} if api_key else {}
    url = f"{FD_BASE_URL}/macro/interest-rates/?start_date={start_date}&end_date={end_date}"
    print(f"  GET {url}")
...
def main():
    ...
    data = fetch_interest_rates(args.start, args.end)
