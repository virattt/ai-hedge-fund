"""
autoresearch/params_tech.py — Sector-specific params for tech (AAPL, NVDA, MSFT, GOOGL, TSLA).

Universe: AAPL, NVDA, MSFT, GOOGL, TSLA
Regime: Growth/momentum. Baseline from params.py.

Run: poetry run python -m autoresearch.evaluate --params autoresearch.params_tech
"""
