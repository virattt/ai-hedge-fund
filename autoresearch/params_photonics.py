"""
autoresearch/params_photonics.py — Sector-specific params for photonics (LITE, COHR).

Universe: Lumentum, Coherent. ikigaistudio LITE 4%, photonics support tier.

Run: poetry run python -m autoresearch.evaluate --params autoresearch.params_photonics
"""
...
RISK_EXTREME_VOL_MULT, RISK_MED_VOL_DECAY, RISK_HIGH_VOL_DECAY = 0.60, 0.5, 0.5
