...
# Header
st.markdown('<div class="main-header">AI Hedge Fund Backtester</div>', unsafe_allow_html=True)
st.markdown("Backtest your AI-powered hedge fund strategy with historical data.")
                        ...
                        if all_dates:
                            ...
                            with viz_tabs[1]:
                                ...
                                if changes_data:
                                    ...
                                    styled_changes = changes_df.style.applymap(highlight_changes, subset=['Signal Changed', 'Confidence Change'])
