...
pub fn save_car_results_csv(result: &EventStudyResult, file_path: &str) -> Result<()> {
    ...
    for e in &result.events {
        ...
        let car_0_1 = e.car_0_1.map(|v| v.to_string()).unwrap_or_else(|| "".to_string());
        let car_0_5 = e.car_0_5.map(|v| v.to_string()).unwrap_or_else(|| "".to_string());
        let car_0_20 = e.car_0_20.map(|v| v.to_string()).unwrap_or_else(|| "".to_string());
