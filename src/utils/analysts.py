...
ANALYST_CONFIG = {
    ...
    "donald_trump": {
        "display_name": "Donald Trump",
         "description": "The Art of the Deal Negotiator",
        "investing_style": "Emphasizes aggressive risk-controlled leverage, brand value exploitation, and macroeconomic opportunism through high-stakes negotiation and media manipulation.",
