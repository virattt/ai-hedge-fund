...
ANALYST_CONFIG = {
    ...
    "elon_musk": {
        ...
        "description": "The Visionary Innovator",
        "investing_style": "Invests in transformative technologies and companies that challenge the status quo, focusing on long-term impact and innovation.",
